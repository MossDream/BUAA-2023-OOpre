...
public class Main {
    ...
    public static void addAction() {
        ...
        actionsMap.put(3, Main::sellBottle);
        actionsMap.put(4, Main::addEquipment);
        actionsMap.put(5, Main::sellEquipment);
        actionsMap.put(6, Main::increaseStar);
        actionsMap.put(7, Main::addFood);
        actionsMap.put(8, Main::sellFood);
        ...
        actionsMap.put(22, Main::sellAllItems);
        actionsMap.put(23, Main::buyAnItem);
    }
    ...
    public static void sellBottle(ArrayList<String> orders) {
        int advId = Integer.parseInt(orders.get(0));
        int botId = Integer.parseInt(orders.get(1));
        advs.get(advId).sellBottle(botId).printIntFirst();
    }
    ...
    public static void sellEquipment(ArrayList<String> orders) {
        int advId = Integer.parseInt(orders.get(0));
        int equipId = Integer.parseInt(orders.get(1));
        advs.get(advId).sellEquipment(equipId).printIntFirst();
    }
    ...
    public static void sellFood(ArrayList<String> orders) {
        int advId = Integer.parseInt(orders.get(0));
        int foodId = Integer.parseInt(orders.get(1));
        advs.get(advId).sellFood(foodId).printIntFirst();
    }
    ...
    public static void enterFightMode(ArrayList<String> orders) {
        ...
        for (String name : fight) {
            int id = advNameToId.get(name);
            Employer employer = advs.get(id);
            employer.notifyEmployees();
            advs.get(id).setFightBeforeHp(advs.get(id).getHp());
        }
        fight.clear();
    }
    ...
    public static void hireAdventure(ArrayList<String> orders) {
        ...
        advs.get(advId1).hire(advId2, advs.get(advId2));
    }
    ...
    public static void sellAllItems(ArrayList<String> orders) {
        int advId = Integer.parseInt(orders.get(0));
        advs.get(advId).sellAllItems();
    }

    public static void buyAnItem(ArrayList<String> orders) {
        int advId = Integer.parseInt(orders.get(0));
        int itemId = Integer.parseInt(orders.get(1));
        String itemName = orders.get(2);
        String type = orders.get(3);
        String others = "";
        if (orders.size() == 5) {
            others = orders.get(4);
        }
        advs.get(advId).buyAnItem(itemId, itemName, type, others);
    }
